...
// Wed Nov 30 17:50:49 2022 by ROOT version 6.24/07
// from TTree LHEF/Analysis tree
// found on file: local_GC_15_1x_1000events.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxRwgt = 927;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("local_GC_15_1x_1000events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("local_GC_15_1x_1000events.root");
      }
